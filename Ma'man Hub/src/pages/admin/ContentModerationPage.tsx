...
const pendingCourses = [
  {
    ...
    description:
      "Deep dive into advanced JavaScript patterns including factory functions, modules, and more.",
    lessons: 24,
    duration: "8h 30m",
  },
  {
    ...
    description:
      "Comprehensive course on ML algorithms, neural networks, and practical applications.",
    lessons: 36,
    duration: "12h",
  },
];
...
const reportedContent = [
  ...
  },
  {
    ...
    type: "review",
    content:
      "Terrible course, the instructor doesn't know what they're talking about. Complete waste of money.",
...
export default function ContentModerationPage() {
  ...
  const handleApproveCourse = (courseId: string) => {
    toast({
      ...
      description: "The course is now live on the platform.",
    });
  };
                    ...
                    <div className="flex gap-6">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <Button
                          variant="destructive"
                          onClick={() =>
                            setRejectDialog({ open: true, courseId: course.id })
                          }
                        >
        ...
        >
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Please provide a reason for rejecting this course. The
